...
stars = [
('06 45 08.91728', '-16 42 58.0171', 'Sirius', 'yellowgreen', 'olivedrab'),
('06 23 57.10988', '-52 41 44.3810', 'Canopus', 'pink', 'purple'),
...
] #'12 47 43.26877', ' -59 41 19.5792'

for ra, dec, name, maycolor, junecolor in stars:
	#Let's start with an equatorial coordinate...
	c = SkyCoord(ra, dec, frame='icrs',  unit=('hour','deg'))
	...
	plt.plot(time,v, '-o', label=name+' May',  color=maycolor)
	plt.plot(time,v_2, '-o', label=name+' June',  color=junecolor)
